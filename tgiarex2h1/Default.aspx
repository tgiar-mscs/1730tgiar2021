<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="tgiarex2h1._Default" %>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <asp:Label ID="Label4" runat="server" Text="DateTime.AddDays(90):"></asp:Label>
                <asp:TextBox ID="TextBox4Result" runat="server" Enabled="False"></asp:TextBox>
            </div>
              <div class="form-group">
                <asp:Label ID="Label5" runat="server" Text="DateTime.AddMonths(3):"></asp:Label>
              ...
              <div class="form-group">
                <asp:Label ID="Label10" runat="server" Text="10) DateA &gt; DateB:" Enabled="False"></asp:Label>
                ...
                <asp:TextBox ID="TextBox10Result" runat="server" Enabled="False" Width="147px"></asp:TextBox>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-6">
            <h2>String Methods</h2> 
                ...
                <asp:TextBox ID="TextBox18" runat="server" Width="180px">1250 Homer Rd, Winona</asp:TextBox>
                ...
                <asp:TextBox ID="TextBox19" runat="server" Width="250px">111 1st St, Lake City, MN 55041</asp:TextBox>
