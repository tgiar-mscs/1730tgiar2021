...
namespace tgiar2f1
{
    public class Ex2fCalculations
    {
        ...
        public static string Calc09(string inputA, string inputB)
        {
            ...
            if (inputA != "" && inputB != "")
            {
                decimal previousMeter = Decimal.Parse(inputA);
                decimal nextMeter = Decimal.Parse(inputB);
                decimal rate = 0.1m;
                total = (nextMeter - previousMeter) * rate;
                if (nextMeter > previousMeter)
                return total.ToString("n2");  
            }
                return "Invalid input";
        }
        ...
        public static string Calc10(string inputA, string inputB)
        {
            ...
            if (inputA != "" && inputB != "")
            {
                double valueOne = Double.Parse(inputA);
                double valueTwo = Double.Parse(inputB);
